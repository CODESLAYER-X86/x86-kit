...
- Usage: Reference from command with `@/home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
