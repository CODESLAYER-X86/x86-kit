...
**Fallback text:**
```
No project skills found. Add skills to any of: `.x86-kit/skills/`, `.x86-kit/skills/`, `.cursor/skills/`, or `.github/skills/` with a `SKILL.md` index file.
```

**Discovery behavior:**
- Scans `.x86-kit/skills/`, `.x86-kit/skills/`, `.cursor/skills/`, `.github/skills/` for subdirectories containing `SKILL.md`
