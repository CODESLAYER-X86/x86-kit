...
- **Global scope**: `/home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/notes/`)
...
2. Glob `/home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/notes/` — works in any directory
