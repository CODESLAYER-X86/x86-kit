...
<!-- For checkpoint task examples and patterns, see @/home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/get-shit-done/references/checkpoints.md -->
...
See `/home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
