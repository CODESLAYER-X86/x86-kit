...
Use template from `/home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/codeslayer_x86/codeslayer/projects/x86-kit/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
